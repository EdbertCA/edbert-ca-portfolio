...
export default function ProjectCard({title, description, technologies, image, github, demo, index}: ProjectCardProps) {
  ...
  return (
    <article className={`flex flex-col max-w-7xl items-center gap-10 px-5 py-8 bg-gray-100 mb-7 rounded-2xl transition-transform duration-250 hover:-translate-y-2 hover:shadow-lg ${swapped}`}>
